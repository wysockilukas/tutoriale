        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Zalogowano');
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // console.log(error.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context2.t0.response.data.message); // console.log(error.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Zmieniono dane');
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_51GwC4fAiMzKc77tQdifGZ8527ffO5FIcLmFcFGzYVwDChXzroLynx2hGqGESZgaTFgsjI6GNGUmsuBcVmuI5vUXg00hA84IfuX');
...
// DOM elements
var leafletDiv = document.getElementById('map');
var logInForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.nav__el--logout');
var submitUserSettingsBtn = document.querySelector('.form-user-data button');
var passChangeForm = document.querySelector('.form-user-settings');
var changePasswdBtn = document.querySelector('.form-user-settings button');
...
if (logInForm) {
  document.querySelector('.form').addEventListener('submit', function (e) {
    e.preventDefault(); // console.log('Byl klik');
...
if (submitUserSettingsBtn) {
  submitUserSettingsBtn.addEventListener('click', function (e) {
    e.preventDefault(); // tworztmy programowo formularz

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]); // updateSettings({ email, name }, 'data');
